  ...
  req = $.ajax({
    ...
    success : function(response) {
      ...
      if (response['objVesselContact']){
        ...
        if (check_null(response['EMAIL'])) vessel_contact_details['Email'] = response['EMAIL'];
      }
      ...
      if(check_null(mobile_num)) vessel_contact_details['Mobile'] = mobile_num;

      if(check_null( response['SATCOM_A_FAX'])) vessel_contact_details['Satcom A Fax'] = response['SATCOM_A_FAX'];
      if(check_null( response['SATCOM_B_FAX'])) vessel_contact_details['Satcom B Fax'] = response['SATCOM_B_FAX'];
      if(check_null( response['SATCOM_A_PHONE'])) vessel_contact_details['Satcom A Phone'] = response['SATCOM_A_PHONE'];
      if(check_null( response['SATCOM_B_PHONE'])) vessel_contact_details['Satcom B Phone'] = response['SATCOM_B_PHONE'];
      if(check_null( response['SATCOM_A_TELEX'])) vessel_contact_details['Satcom A Telex'] = response['SATCOM_A_TELEX'];
      if(check_null( response['SATCOM_B_TELEX'])) vessel_contact_details['Satcom B Telex'] = response['SATCOM_B_TELEX'];
      if(check_null( response['SATCOM_C1'])) vessel_contact_details['Satcom C1'] = response['SATCOM_C1'];
      if(check_null( response['SATCOM_C2'])) vessel_contact_details['Satcom C2'] = response['SATCOM_C2'];
      if(check_null( response['SATCOM_F'])) vessel_contact_details['Satcom F'] = response['SATCOM_F'];
      if(check_null( response['SATCOM_M1'])) vessel_contact_details['Satcom M1'] = response['SATCOM_M1'];
      if(check_null( response['SATCOM_M2'])) vessel_contact_details['Satcom M2'] = response['SATCOM_M2'];
      if(check_null( response['SATCOM_MINI_M'])) vessel_contact_details['Satcom Mini'] = response['SATCOM_MINI_M'];
      if(check_null( response['TELEPHONE_1'])) vessel_contact_details['Telephone 1'] = response['TELEPHONE_1'];
      if(check_null( response['TELEPHONE_2'])) vessel_contact_details['Telephone 2'] = response['TELEPHONE_2'];
      if(check_null( response['TELEPHONE_3'])) vessel_contact_details['Telephone 3'] = response['TELEPHONE_3'];
